        ...
        <div class="auth-form">
          ...
          <form action="{{ route('auth.register') }}" method="POST" id="registerForm">
            ...
            <div class="auth-form_input my-4">
              ...
              <div class="input-error username-error p-2" style="color: #FE4C50" style="display: none;"></div>
            </div>

            <div class="auth-form_input my-4">
              <input type="text" class="form-control form-control-lg" id="registerEmail" name="email" placeholder="Email">
              <div class="input-error email-error p-2"  style="color: #FE4C50" style="display: none;"></div>
            </div>

            <div class="auth-form_input my-4">
              <input type="password" class="form-control form-control-lg" id="registerPassword" name="password" placeholder="Mật khẩu">
              <div class="input-error password-error p-2" style="color: #FE4C50" style="display: none;"></div>
            </div>
            ...
            <button type="submit" class="auth-form_btn btn btn-lg text-white bg-main w-100" style="background-color: #FE4C50; cursor: pointer;">Đăng ký</button>

            <div class="auth-form_bottom mt-4 text-center">
              Đã có tài khoản ? 
              <a type="button" data-toggle="modal" data-target="#loginModal" data-dismiss="modal" style="color: #FE4C50; cursor: pointer;">Đăng nhập</a>
            </div>
